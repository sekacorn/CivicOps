...
/**
 * Central authorization seam for organization-owned resources once authenticated principals are
 * introduced.
 */
@Service
public class OrganizationAccessService {
  ...
  public OrganizationMembership requireAnyRole(
      UUID userId, UUID organizationId, Set<Role> allowedRoles) {
  ...
  public OrganizationMembership requireMembership(UUID userId, UUID organizationId) {
    return memberships
        .findByOrganizationIdAndUserIdAndActiveTrue(organizationId, userId)
